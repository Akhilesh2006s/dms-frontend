...
export const TestimonialsColumn = (props: {
  className?: string
  testimonials: (Testimonial & { company?: string })[]
  duration?: number
}) => {
  return (
              ...
              {props.testimonials.map(({ text, name, role, company }, i) => (
                ...
                >
                  ...
                  <div className="mt-5">
                    ...
                    <div className="leading-5 opacity-60 tracking-tight text-gray-300">{role}{company ? <span className="block text-xs text-gray-400">at {company}</span> : null}</div>
                  </div>
                </div>
              ))}
            </React.Fragment>
