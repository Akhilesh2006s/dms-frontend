...
const features = [
  {
    ...
    description:
      "Capture leads from web, forms, and imports. Auto-assign, score, and prioritize with SLAs so no lead slips.",
  ...
  },
  {
    ...
    description:
      "Visual pipelines, stages, and activities. Drag-and-drop deals, automate follow-ups, and track conversions.",
  ...
  },
  {
    ...
    description:
      "One inbox for email, phone, and chat. Templates and automations to reply faster and stay consistent.",
  ...
  },
  {
    ...
    description:
      "Auto-create tasks, reminders, and SLAs. Never miss follow-ups and keep the team on track.",
  ...
  },
  {
    title: "Integrations",
    description:
      "Connect calendar, WhatsApp, email, and your existing tools to build a unified workflow.",
  ...
  },
  {
    ...
    description:
      "Dashboards for pipeline health, team performance, and revenue forecasting in real-time.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-sm font-medium mb-6">
              ...
              Unified DMS - Close Faster, Retain Longer
            </div>
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              Manage leads, pipeline, communications, tasks, and reporting in one place — with automation that does the
              busywork for you.
            </p>
          </div>
